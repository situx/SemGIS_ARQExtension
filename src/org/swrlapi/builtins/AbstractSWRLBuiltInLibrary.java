...
/**
 * A class that must be subclassed by a class implementing a library of SWRL
 * built-in methods.
 * <p>
 * Provides invocation context for invoked built-ins (such the prefix of
 * invoking rule, whether the invocation is in the consequent or the antecedent)
 * and access to the invoking {@link org.swrlapi.builtins.SWRLBuiltInBridge}.
 * Also provides implementations for a large number of SWRL built-in argument
 * processing methods.
 *
...
public abstract class AbstractSWRLBuiltInLibrary
    ...
    @NonNull
    private final Set<@NonNull String> builtInNames;
    ...
    @NonNull
    private Map<@NonNull String, @NonNull Long> invocationPatternMap;
    ...
    @NonNull
    public Set<@NonNull String> getBuiltInNames() {
        return new HashSet<>(this.builtInNames);
    }

    @NonNull
    public Set<@NonNull IRI> getBuiltInIRIs() {
    ...
    @Override
    public boolean invokeBuiltInMethod(@NonNull Method method, @NonNull SWRLBuiltInBridge bridge,
     ...
     * @throws SWRLBuiltInLibraryException If an error occurs during factory
     * retrieval
     */
    @NonNull
    protected SQWRLResultValueFactory getSQWRLResultValueFactory() throws SWRLBuiltInLibraryException {
        return getBuiltInBridge().getSWRLAPIOWLDataFactory().getSQWRLResultValueFactory();
    }

    /**
     * Create a string that represents a unique invocation pattern for a
     * built-in for a bridge/rule/built-in/arguments combination.
     *
     ...
     * @throws SWRLBuiltInException If the parameters are invalid or if there is
     * an error during pattern generation
     */
    @NonNull
    protected String createInvocationPattern(@NonNull SWRLBuiltInBridge bridge, @NonNull String ruleName,
    ...
    @NonNull
    protected IRI createIRI(@NonNull String fullName) throws SWRLBuiltInException {
        try {
    ...
    @Override
    public void checkNumberOfArgumentsAtLeastOne(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        if (arguments.size() < 1) {
    ...
    @Override
    public void checkThatAllArgumentsAreOWLLiterals(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    @NonNull
    public String getLiteralArgumentDatatypeName(int argumentNumber,
    ...
    @Override
    public void checkThatAllArgumentsAreNumeric(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public void checkThatAllArgumentsAreInts(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean areAllArgumentsBytes(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean areAllArgumentsShorts(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean areAllArgumentsInts(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean areAllArgumentsLongs(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean areAllArgumentsFloats(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean areAllArgumentsDoubles(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean areAllArgumentsDecimals(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean areAllArgumentsIntegers(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean isArgumentConvertibleToByte(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        return (isArgumentNumeric(argumentNumber, arguments) && isArgumentAByte(argumentNumber, arguments));
    }

    @Override
    public boolean isArgumentConvertibleToShort(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        return (isArgumentAByte(argumentNumber, arguments) || isArgumentAShort(argumentNumber, arguments));
    }

    @Override
    public boolean isArgumentConvertibleToInt(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        return (isArgumentAByte(argumentNumber, arguments) || isArgumentAShort(argumentNumber, arguments)
    ...
    @Override
    public boolean isArgumentConvertibleToLong(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @Override
    public boolean isArgumentConvertibleToFloat(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        return isArgumentAByte(argumentNumber, arguments) && isArgumentAShort(argumentNumber, arguments) || isArgumentAnInt(
    ...
    @Override
    public boolean isArgumentConvertibleToDouble(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        return isArgumentAByte(argumentNumber, arguments) || isArgumentAShort(argumentNumber, arguments) || isArgumentAnInt(
    ...
    @Override
    public boolean isWidestNumericArgumentAByte(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean isWidestNumericArgumentAShort(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean isWidestNumericArgumentAnInt(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean isWidestNumericArgumentALong(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean isWidestNumericArgumentAnInteger(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean isWidestNumericArgumentAFloat(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean isWidestNumericArgumentADouble(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
            if (isArgumentADecimal(argumentNumber, arguments)) {
                return false;
    ...
    @Override
    public boolean areAllArgumentsBooleans(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean areAllArgumentLiterals(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean areAllArgumentsNumeric(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean areAllArgumentsStrings(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean areAllArgumentsOfAnOrderedType(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public void checkThatAllArgumentsAreFloats(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public void checkThatAllArgumentsAreStrings(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public void checkThatAllArgumentsAreOfAnOrderedType(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++) {
    ...
    @Override
    public boolean isArgumentAnOWLNamedIndividual(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @Override
    public void checkThatArgumentIsANamedIndividual(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @Override
    public void checkThatArgumentIsALiteral(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        if (!isArgumentALiteral(argumentNumber, arguments)) {
            throw new InvalidSWRLBuiltInArgumentException(argumentNumber,
    ...
    @NonNull
    @Override
    public IRI getArgumentAsANamedIndividualIRI(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public SWRLNamedIndividualBuiltInArgument getArgumentAsANamedIndividual(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        checkThatArgumentIsANamedIndividual(argumentNumber, arguments);
    ...
    @NonNull
    @Override
    public IRI getArgumentAsAClassIRI(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public SWRLClassBuiltInArgument getArgumentAsAClass(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        checkThatArgumentIsAClass(argumentNumber, arguments);
    ...
    @NonNull
    @Override
    public SWRLClassExpressionBuiltInArgument getArgumentAsAClassExpression(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @NonNull
    public SWRLPropertyBuiltInArgument getArgumentAsAProperty(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public SWRLObjectPropertyExpressionBuiltInArgument getArgumentAsAnObjectPropertyExpression(
    ...
    @NonNull
    @Override
    public SWRLDataPropertyExpressionBuiltInArgument getArgumentAsADataPropertyExpression(
            int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public SWRLAnnotationPropertyBuiltInArgument getArgumentAsAnAnnotationProperty(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public SWRLDatatypeBuiltInArgument getArgumentAsADatatype(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public IRI getArgumentAsAnIRI(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public IRI getArgumentAsAPropertyIRI(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        checkThatArgumentIsAProperty(argumentNumber, arguments);
    ...
    @Override
    public void checkArgumentNumber(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    @Override
    public boolean isArgumentNumeric(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    // Bytes
    @Override
    public void checkThatArgumentIsAByte(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        if (!isArgumentAByte(argumentNumber, arguments)) {
            throw new InvalidSWRLBuiltInArgumentException(argumentNumber,
    ...
    @Override
    public boolean isArgumentAByte(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        return isArgumentALiteral(argumentNumber, arguments) && (getArgumentAsALiteral(argumentNumber, arguments).isByte());
    }

    @Override
    public short getArgumentAsAByte(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    // Shorts
    @Override
    public void checkThatArgumentIsAShort(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        if (!isArgumentAShort(argumentNumber, arguments)) {
            throw new InvalidSWRLBuiltInArgumentException(argumentNumber,
    ...
    @Override
    public boolean isArgumentAShort(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        return isArgumentALiteral(argumentNumber, arguments) && (getArgumentAsALiteral(argumentNumber, arguments)
                .isShort());
    }
    ...
    @Override
    public short getArgumentAsAShort(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    // Ints
    @Override
    public void checkThatArgumentIsAnInt(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        if (!isArgumentAnInt(argumentNumber, arguments)) {
            throw new InvalidSWRLBuiltInArgumentException(argumentNumber,
    ...
    @Override
    public boolean isArgumentAnInt(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        return isArgumentALiteral(argumentNumber, arguments) && (getArgumentAsALiteral(argumentNumber, arguments).isInt());
    }

    @Override
    public int getArgumentAsAnInt(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    @Override
    public int getArgumentAsAPositiveInt(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public BigInteger getArgumentAsAnInteger(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public BigInteger getArgumentAsAnInteger(@NonNull SWRLBuiltInArgument argument)
            throws SWRLBuiltInException {
    ...
    @Override
    public boolean isArgumentAnInteger(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        return isArgumentALiteral(argumentNumber, arguments) && (getArgumentAsALiteral(argumentNumber, arguments)
                .isInteger());
    }
    ...
    @Override
    public BigInteger getArgumentAsAPositiveInteger(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public BigDecimal getArgumentAsADecimal(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public BigDecimal getArgumentAsADecimal(@NonNull SWRLBuiltInArgument argument)
            throws SWRLBuiltInException {
    ...
    @Override
    public boolean isArgumentADecimal(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        return isArgumentALiteral(argumentNumber, arguments) && (getArgumentAsALiteral(argumentNumber, arguments)
                .isDecimal());
    }
    ...
    // General
    @Override
    public boolean isArgumentALiteral(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    @Override
    public boolean isArgumentAnAnnotationProperty(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        checkThatArgumentIsBound(argumentNumber, arguments);
    ...
    @Override
    public boolean isArgumentADatatype(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        checkThatArgumentIsBound(argumentNumber, arguments);
    ...
    @Override
    public boolean isArgumentADataPropertyExpression(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        checkThatArgumentIsBound(argumentNumber, arguments);

        return arguments.get(argumentNumber).getSWRLBuiltInArgumentType() == SWRLBuiltInArgumentType.DATA_PROPERTY_EXPRESSION
    ...
    @Override
    public boolean isArgumentAnObjectPropertyExpression(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        checkThatArgumentIsBound(argumentNumber, arguments);

        return arguments.get(argumentNumber).getSWRLBuiltInArgumentType() == SWRLBuiltInArgumentType.OBJECT_PROPERTY_EXPRESSION
    ...
    @Override
    public void checkThatArgumentIsAnObjectPropertyExpression(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @Override
    public void checkThatArgumentIsAnAnnotationProperty(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @Override
    public void checkThatArgumentIsADatatype(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @Override
    public void checkThatArgumentIsADataPropertyExpression(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @Override
    public void checkThatArgumentIsAClassPropertyOrNamedIndividual(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @Override
    public boolean isArgumentAClassPropertyOrNamedIndividual(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @Override
    public boolean isArgumentAClass(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        checkThatArgumentIsBound(argumentNumber, arguments);
    ...
    @Override
    public boolean isArgumentAClassExpression(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        checkThatArgumentIsBound(argumentNumber, arguments);
    ...
    @Override
    public void checkThatArgumentIsAClassExpression(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public OWLLiteral getArgumentAsAnOWLLiteral(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        checkThatArgumentIsALiteral(argumentNumber, arguments);
    ...
    @NonNull
    @Override
    public OWLLiteral getArgumentAsAnOWLLiteral(SWRLBuiltInArgument argument)
            throws SWRLBuiltInException {
    ...
    @Override
    public boolean isArgumentALong(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        return isArgumentALiteral(argumentNumber, arguments) && (getArgumentAsALiteral(argumentNumber, arguments).isLong());
    }

    @Override
    public long getArgumentAsALong(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    @Override
    public boolean isArgumentAFloat(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        return isArgumentALiteral(argumentNumber, arguments) && (getArgumentAsALiteral(argumentNumber, arguments)
                .isFloat());
    }
    ...
    @Override
    public float getArgumentAsAFloat(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    public Point getArgumentAsAPoint(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        return (Point) parseGeometryFromString(getArgumentAsALiteral(arguments.get(argumentNumber)).getString(), "Point"); // Will throw LiteralException if invalid.
    }

    public Polygon getArgumentAsAPolygon(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        return (Polygon) parseGeometryFromString(getArgumentAsALiteral(arguments.get(argumentNumber)).getString(), "Polygon"); // Will throw LiteralException if invalid.
    }

    public LineString getArgumentAsALineString(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        return (LineString) parseGeometryFromString(getArgumentAsALiteral(arguments.get(argumentNumber)).getString(), "LineString"); // Will throw LiteralException if invalid.
    }

    public Geometry getArgumentAsAGeometry(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        return parseGeometryFromString(getArgumentAsALiteral(arguments.get(argumentNumber)).getString(), null); // Will throw LiteralException if invalid.
    }

    public GridCoverage2D getArgumentAsACoverage(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        return (GridCoverage2D) parseGeometryFromString(getArgumentAsALiteral(arguments.get(argumentNumber)).getString(), null); // Will throw LiteralException if invalid.
    }
    ...
    @Override
    public boolean isArgumentADouble(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        return isArgumentALiteral(argumentNumber, arguments) && (getArgumentAsALiteral(argumentNumber, arguments)
                .isDouble());
    }
    ...
    @Override
    public boolean isArgumentABoolean(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        return isArgumentALiteral(argumentNumber, arguments) && (getArgumentAsALiteral(argumentNumber, arguments)
                .isBoolean());
    }
    ...
    @Override
    public boolean isArgumentAString(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public String representArgumentAsAString(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    // Time
    @Override
    public void checkThatArgumentIsATime(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @Override
    public boolean isArgumentATime(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    @Override
    @NonNull
    public XSDTime getArgumentAsATime(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    // Date
    @Override
    public void checkThatArgumentIsADate(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @Override
    public boolean isArgumentADate(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public XSDDate getArgumentAsADate(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    // DateTime
    @Override
    public void checkThatArgumentIsADateTime(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @Override
    public boolean isArgumentADateTime(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        return isArgumentALiteral(argumentNumber, arguments) && getArgumentAsALiteral(argumentNumber, arguments)
                .isDateTime();
    }
    ...
    @NonNull
    @Override
    public XSDDateTime getArgumentAsADateTime(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    // Duration
    @Override
    public void checkThatArgumentIsADuration(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @Override
    public boolean isArgumentADuration(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        return isArgumentALiteral(argumentNumber, arguments) && getArgumentAsALiteral(argumentNumber, arguments)
                .isDuration();
    }
    ...
    @NonNull
    @Override
    public XSDDuration getArgumentAsADuration(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @Override
    public boolean hasUnboundArguments(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    @Override
    public void checkThatAllArgumentsAreBound(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    @Override
    public boolean isUnboundArgument(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        checkArgumentNumber(argumentNumber, arguments);
    ...
    @Override
    public boolean isBoundArgument(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        checkArgumentNumber(argumentNumber, arguments);
    ...
    /**
     * Get 0-offset position of first unbound argument; return -1 if no unbound
     * arguments are found.
     */
    @Override
    public int getFirstUnboundArgument(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    @Override
    public void checkForUnboundArguments(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    @Override
    public void checkThatAllArgumentsAreBoundVariables(@NonNull List<@NonNull SWRLBuiltInArgument> arguments,
            @NonNull String message) throws SWRLBuiltInException {
        for (SWRLBuiltInArgument argument : arguments) {
    ...
    @Override
    public void checkForUnboundNonFirstArguments(@NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
    ...
    @Override
    public String getVariableName(int argumentNumber, @NonNull List<@NonNull SWRLBuiltInArgument> arguments)
            throws SWRLBuiltInException {
        checkArgumentNumber(argumentNumber, arguments);
    ...
    @NonNull
    public String makeInvalidArgumentTypeMessage(@NonNull SWRLBuiltInArgument argument,
    ...
    /**
     * Take an bound Argument object with types ClassArgument, PropertyArgument,
     * IndividualArgument, or LiteralArgument and return it as a property value
     * representation. Class, property and individual arguments are represented
     * by their IRIs; data value objects are represented by the appropriate Java
     * type. Primitive XSD datatypes that do not have a corresponding Java type
    ...
    @Override
    public void checkForUnboundArguments(@NonNull String ruleName, @NonNull String builtInName,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        for (SWRLBuiltInArgument argument : arguments) {
            if (argument.isVariable() && argument.asVariable().isUnbound()) {
                throw new SWRLBuiltInException(
    ...
    @NonNull
    @Override
    public List<@NonNull SWRLBuiltInArgument> cloneArguments(
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) {
        return new ArrayList<>(arguments);
    }

    @Override
    public boolean processResultArgument(@NonNull List<@NonNull SWRLBuiltInArgument> arguments,
    ...
    public boolean processResultArgument(@NonNull List<@NonNull SWRLBuiltInArgument> arguments,
            int resultArgumentNumber, @NonNull Geometry resultArgument) throws SWRLBuiltInException {
        return processResultArgument(arguments, resultArgumentNumber, createLiteralBuiltInArgument(resultArgument));
    }
    ...
    @NonNull
    @Override
    public SWRLClassExpressionBuiltInArgument createClassExpressionBuiltInArgument(
    ...
    @NonNull
    @Override
    public SWRLNamedIndividualBuiltInArgument createNamedIndividualBuiltInArgument(
    ...
    @NonNull
    @Override
    public SWRLObjectPropertyBuiltInArgument createObjectPropertyBuiltInArgument(
    ...
    @NonNull
    @Override
    public SWRLObjectPropertyExpressionBuiltInArgument createObjectPropertyExpressionBuiltInArgument(
    ...
    @NonNull
    @Override
    public SWRLDataPropertyBuiltInArgument createDataPropertyBuiltInArgument(
    ...
    @NonNull
    @Override
    public SWRLDataPropertyExpressionBuiltInArgument createDataPropertyExpressionBuiltInArgument(
    ...
    @NonNull
    @Override
    public SWRLAnnotationPropertyBuiltInArgument createAnnotationPropertyBuiltInArgument(
    ...
    @NonNull
    @Override
    public SWRLDatatypeBuiltInArgument createDatatypeBuiltInArgument(@NonNull OWLDatatype datatype) {
        return getSWRLBuiltInArgumentFactory().getDatatypeBuiltInArgument(datatype);
    }

    @Override
    @NonNull
    public SWRLLiteralBuiltInArgument createLiteralBuiltInArgument(@NonNull OWLLiteral literal) {
        return getSWRLBuiltInArgumentFactory().getLiteralBuiltInArgument(literal);
    }

    @NonNull
    @Override
    public SWRLLiteralBuiltInArgument createLiteralBuiltInArgument(@NonNull String s) {
    ...
    @NonNull
    @Override
    public SWRLLiteralBuiltInArgument createLiteralBuiltInArgument(BigDecimal d) {
        return getSWRLBuiltInArgumentFactory().getLiteralBuiltInArgument(d);
    }

    @NonNull
    @Override
    public SWRLLiteralBuiltInArgument createLiteralBuiltInArgument(BigInteger d) {
        return getSWRLBuiltInArgumentFactory().getLiteralBuiltInArgument(d);
    }
    ...
    @NonNull
    @Override
    public SWRLMultiValueVariableBuiltInArgument createSWRLMultiValueVariableBuiltInArgument(
            IRI variableIRI) {
    ...
    @NonNull
    @Override
    public SQWRLCollectionVariableBuiltInArgument createSQWRLCollectionVariableBuiltInArgument(
    ...
    @NonNull
    @Override
    public SWRLLiteralBuiltInArgument createLeastNarrowNumericLiteralBuiltInArgument(double value,
    ...
    @NonNull
    @Override
    public SWRLLiteralBuiltInArgument createLeastNarrowNumericLiteralBuiltInArgument(BigDecimal value,
            @NonNull List<@NonNull SWRLBuiltInArgument> boundInputNumericArguments) throws SWRLBuiltInException {
        OWLLiteral literal = createLeastNarrowNumericOWLLiteral(value, boundInputNumericArguments);
    ...
    @NonNull
    protected OWLNamedIndividual injectOWLNamedIndividualOfClass(@NonNull OWLClass cls) {
    ...
    @NonNull
    @Override
    public Map<@NonNull Integer, @NonNull SWRLMultiValueVariableBuiltInArgument> createOutputMultiValueArguments(
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
    ...
    @NonNull
    @Override
    public Map<Integer, @NonNull OWLObject> getInputArgumentValues(
    ...
    private OWLLiteral createLeastNarrowNumericOWLLiteral(double value,
            @NonNull List<@NonNull SWRLBuiltInArgument> boundInputNumericArguments) throws SWRLBuiltInException { // TODO Check for overflow
    ...
    @NonNull
    private OWLLiteral createLeastNarrowNumericOWLLiteral(BigDecimal value,
            @NonNull List<@NonNull SWRLBuiltInArgument> boundInputNumericArguments) throws SWRLBuiltInException { // TODO Check for overflow
        if (isWidestNumericArgumentAByte(boundInputNumericArguments)) {
    ...
    @NonNull
    private Literal getArgumentAsALiteral(int argumentNumber,
            @NonNull List<@NonNull SWRLBuiltInArgument> arguments) throws SWRLBuiltInException {
        checkThatArgumentIsALiteral(argumentNumber, arguments);
