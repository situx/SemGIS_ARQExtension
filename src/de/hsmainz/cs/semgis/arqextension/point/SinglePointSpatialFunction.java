...
public abstract class SinglePointSpatialFunction extends SingleGeometrySpatialFunction {
	...
	protected NodeValue exec(Geometry g, GeoSPARQLLiteral datatype, Binding binding, List<NodeValue> evalArgs,
	      ...
	      Point point = (Point) geom.getNode().getLiteralValue();
	      return exec(point, datatype, binding, evalArgs, uri, env);
	}
	
	   protected abstract NodeValue exec(Point g, GeoSPARQLLiteral datatype, Binding binding,
