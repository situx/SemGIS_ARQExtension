...
import de.hsmainz.cs.semgis.arqextension.geometry.IsEmpty;
import de.hsmainz.cs.semgis.arqextension.geometry.IsSimple;
import de.hsmainz.cs.semgis.arqextension.geometry.IsValid;
...
import de.hsmainz.cs.semgis.arqextension.geometry.SRID;
...
public class GeoSPARQLFunctionFactory implements IterableFunctionFactory {
    ...
    public GeoSPARQLFunctionFactory() {
        ...
        functions.put(PostGISGeo.st_rast_isEmpty.getURI(), de.hsmainz.cs.semgis.arqextension.raster.IsEmpty.class);
        functions.put(PostGISGeo.st_rast_Contains.getURI(), de.hsmainz.cs.semgis.arqextension.raster.Contains.class);
        functions.put(PostGISGeo.st_rast_Covers.getURI(), de.hsmainz.cs.semgis.arqextension.raster.Covers.class);
        functions.put(PostGISGeo.st_rast_CoveredBy.getURI(), de.hsmainz.cs.semgis.arqextension.raster.CoveredBy.class);
        functions.put(PostGISGeo.st_rast_Disjoint.getURI(), de.hsmainz.cs.semgis.arqextension.raster.Disjoint.class);
        functions.put(PostGISGeo.st_rast_Intersects.getURI(), de.hsmainz.cs.semgis.arqextension.raster.Intersects.class);
        functions.put(PostGISGeo.st_rast_Overlaps.getURI(), de.hsmainz.cs.semgis.arqextension.raster.Overlaps.class);
        functions.put(PostGISGeo.st_rast_srid.getURI(), de.hsmainz.cs.semgis.arqextension.raster.SRID.class);
        functions.put(PostGISGeo.st_rast_Touches.getURI(), de.hsmainz.cs.semgis.arqextension.raster.Touches.class);
        functions.put(PostGISGeo.st_rast_Within.getURI(), de.hsmainz.cs.semgis.arqextension.raster.Within.class);
