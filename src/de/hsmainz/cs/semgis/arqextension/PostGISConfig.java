...
public class PostGISConfig {
    ...
    public static final void setup() {
        ...
        if (!IS_FUNCTIONS_REGISTERED) {
            ...
            functionRegistry.put(PostGISGeo.st_isSimple.getURI(), IsSimple.class);
            functionRegistry.put(PostGISGeo.st_isValid.getURI(), IsValid.class);
            ...
            functionRegistry.put(PostGISGeo.st_srid.getURI(), SRID.class);
